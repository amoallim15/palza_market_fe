    ...
    <div>
      ...
      <div className="flex flex-row my-4">
        <div className="h-12 flex items-center">
          <span className="text-sm leading-8">{Lang.total}</span> <span className="font-bold mx-1 text-sm leading-8">{magazineData.info?.count}</span><span className="text-sm leading-8">{Lang.articles}</span>
        </div>
      </div>
      {/**/}
